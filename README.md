...
- Explore and Analyse Places - Mining Events data - Using Pandas DataFrames & Deep Learning Transformers.  

**IMPORTANT** For visualizing the "Analysing_Events" notebooks we recommend to click here:
